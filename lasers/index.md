...
This is an ornament I created with space for adding a name. This version uses a support bar beneath the name to make updates very easy. The file includes basic instructions for changing the name.
